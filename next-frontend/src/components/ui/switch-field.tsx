...
export function SwitchField({
  ...
  return (
    <label className={cn("flex cursor-pointer items-start justify-between gap-4 rounded-md border border-line-strong bg-background p-3", className)}>
