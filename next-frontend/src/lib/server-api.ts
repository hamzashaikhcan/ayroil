...
export const FALLBACK_PRODUCT: Product = {
  ...
  ingredients: [
    { name: "Active 01", description: "The core compound that does the actual work." },
    { name: "Active 02", description: "Stabilizes the formula and keeps it shelf-stable." },
    { name: "Carrier", description: "A gentle base that helps the actives reach where they need to go." },
  ],
  faqs: [
    { q: "How long does one bottle last?", a: "Used as directed, about 30 days." },
    { q: "Is it gentle?", a: "Yes — no sulfates, parabens, or artificial dyes." },
    { q: "Where is it made?", a: "Brooklyn, NY. Hand-finished in-house." },
    { q: "What is your return policy?", a: "30 days, full refund, no questions." },
  ],
